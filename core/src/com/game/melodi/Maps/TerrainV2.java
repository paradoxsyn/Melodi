...
public class TerrainV2  {
    ...
    public void init(Melodi game) {
        ...
        System.out.println(Arrays.toString(normfeed));
    ...
    public void updatePhysics(int startIndex, int endIndex){
        ...
        //chain.createChain(new Vector2[] {new Vector2(0,0f),new Vector2(10,4),new Vector2(20,2),new Vector2(0,100)});
    ...
    public void render () {
        ...
        //game.world.stage.getCamera().position.x+=0.02f;
        //cam.position.x+=5;
        //cam.update();
